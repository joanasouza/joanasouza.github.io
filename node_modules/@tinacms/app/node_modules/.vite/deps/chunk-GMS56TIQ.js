...
async function importCodeMirror(addons, options) {
  const CodeMirror = await import("./codemirror.es-LY5K46PR.js").then(function(n2) {
    return n2.c;
  }).then((c2) => typeof c2 === "function" ? c2 : c2.default);
  await Promise.all((options == null ? void 0 : options.useCommonAddons) === false ? addons : [
    import("./show-hint.es-WJEWU6IO.js").then(function(n2) {
      return n2.s;
    }),
    import("./matchbrackets.es-24VDVUFN.js").then(function(n2) {
      return n2.m;
    }),
    import("./closebrackets.es-L3QA334W.js").then(function(n2) {
      return n2.c;
    }),
    import("./brace-fold.es-UZLKPOVK.js").then(function(n2) {
      return n2.b;
    }),
    import("./foldgutter.es-72GD7LF5.js").then(function(n2) {
      return n2.f;
    }),
    import("./lint.es3-FAQRFZIC.js").then(function(n2) {
      return n2.l;
    }),
    import("./searchcursor.es-ZIFAFPZQ.js").then(function(n2) {
      return n2.s;
    }),
    import("./jump-to-line.es-W7PG2YN3.js").then(function(n2) {
      return n2.j;
    }),
    import("./dialog.es-VGBWTZWJ.js").then(function(n2) {
      return n2.d;
    }),
    import("./sublime.es-FV45H6DA.js").then(function(n2) {
      return n2.s;
    }),
    ...addons
  ]);
...
function useHeaderEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./javascript.es-2MQ33TWF.js").then(function(n2) {
        return n2.j;
      })
    ]).then((CodeMirror) => {
      if (!isActive) {
...
function useQueryEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./comment.es-R3C67O4O.js").then(function(n2) {
        return n2.c;
      }),
      import("./search.es-54SXMSWN.js").then(function(n2) {
        return n2.s;
      }),
      import("./hint.es-KKU3RKJP.js"),
      import("./lint.es-D2DMHCXT.js"),
      import("./info.es-TBSYSKFU.js"),
      import("./jump.es-KZ4UQMDD.js"),
      import("./mode.es-3O23TTYB.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useVariableEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./hint.es2-QIUX365W.js"),
      import("./lint.es2-NGC5QZPJ.js"),
      import("./mode.es3-NQK4TUQB.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function useResponseEditor({
  ...
  (0, import_react.useEffect)(() => {
    ...
    importCodeMirror([
      ...
      import("./mode.es2-SJN5K63V.js"),
      import("./info-addon.es-MOLRREIJ.js")
    ], {
...
@graphiql/react/dist/index.es.js:
  ...
  ***************************************************************************** *)
   ...
   *)
*/
//# sourceMappingURL=chunk-GMS56TIQ.js.map
